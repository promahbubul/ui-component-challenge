...
const PrimaryAccordianCard = ({ title, subtitle, cardBorder, rounded, border }) => {
    ...
    <>
      <div className={`text-sm ${border} border-white  `}>
        <div
          ...
          className={`flex bg-[#5f5af6] ${rounded}  py-2 px-5  flex-row justify-between cursor-pointer`}
        >
        ...
        >
          <div className={`overflow-hidden border-x ${cardBorder} border-[#5f5af6] ${accordian && "p-5"}  `}>
...
export default PrimaryAccordianCard;
